...
# @function_tool
# def Addition():
#     return 10 * 7 ---> Function name Addition or km multiply ka kr rha hai isse agent confuse hojaega.. Function name meaningful rkhen..
...
# def send_email(from_email, to_email, subject, body) ->: Homework exercise
